...
Análise de Categorias e Descontos: Avaliação de quais categorias de produtos (Suprimentos, Tecnologia, Móveis) geram maior faturação e qual a média de desconto aplicada por subcategoria (como mesas e máquinas).

Distribuição Geográfica: Mapeamento visual da média de vendas por país e análise cruzada do volume de vendas por nível de prioridade das encomendas.

<img width="1304" height="731" alt="image" src="https://github.com/user-attachments/assets/5441efa9-c626-4efd-af7a-a49b0c0e5bc6" />
...
Impacto Logístico: Avaliação do valor de vendas segmentado por Modo de Envio (Classe Padrão, Primeira Classe, Mesmo Dia) através de um gráfico de cascata (Waterfall).

Custos por Mercado: Mapeamento da média de custos de envio distribuída pelas diferentes regiões globais (APAC, EU, LATAM, US, etc.) utilizando um Treemap.

Média de Lucro: Identificação das categorias de produtos que trazem a maior fatia de lucro para a operação.

<img width="1305" height="723" alt="image" src="https://github.com/user-attachments/assets/4834fde1-5eb8-4b98-a1c1-bfbfabf468ce" />
